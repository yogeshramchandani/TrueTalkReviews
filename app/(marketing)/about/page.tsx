    ...
    <main className="min-h-screen bg-white font-sans">
      ...
      <section className="relative bg-slate-900 py-24 px-4 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-10">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-teal-500 rounded-full blur-[128px]"></div>
        </div>

        <div className="container mx-auto max-w-4xl text-center relative z-10 mt-6">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-linear-to-r from-teal-400 to-teal-200">Verified Trust Layer.</span>
          </h1>
